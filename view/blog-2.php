  ...
  <body>
    ...
    <section class="ftco-section">
      <div class="container" >
        ...
        <?php 
            $arrayten =array("Lượt bình luận và đánh giá của sản phẩm","Lượt bình luận và đánh giá của sản phẩm","Lượt bình luận và đánh giá của sản phẩm");
            $arrayngay =array("May 6, 2021","May 6, 2021","May 6, 2021");
            $arraybtn = array("Xem chi tiết","Xem chi tiết","Xem chi tiết");
             $arrayhinh =array("image_3.jpg","image_4.jpg","image_5.jpg");
