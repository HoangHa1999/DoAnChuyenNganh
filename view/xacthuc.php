      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.php">Trang Chủ <i class="fa fa-chevron-right"></i></a></span> <span>Xác Thực Và Đặt Mật Khẩu Mới <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Xác Thực Và Đặt Mật Khẩu Mới</h2>
          </div>
        </div>
      </div>
    </section>
              ...
              ?>
                ...
                <div class="col-md-12">
	                <div class="form-group">
	                	<label for="emailaddress">Mã Xác Thực</label>
	                  <input type="text" name="txt_mxt" class="form-control"  required="required">
	                </div>
	              </div>
                <div class="col-md-12">
	                <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
					<button type="submit" name ="btndangnhap" class="btn btn-primary">Xác nhận</button>
