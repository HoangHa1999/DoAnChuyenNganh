<div class="wrap">
			<div class="container">
		        ...
		        <div class="reg">
		        	<p class="mb-0"><a href="thongtincanhan.php" class="mr-2">Thông Tin Cá Nhân</a>
		        	<a href="index.php" class="mr-2">Đăng xuất</a></p> 
		        </div>
					</div>
				</div>
			</div>
	    ...
	    <div class="container">
          ...
          <div class="dropdown-menu dropdown-menu-right">
				    <div class="dropdown-item d-flex align-items-start" href="#">
				    	<div class="img" style="background-image: url(images/img-01.jpg);"></div>
				    	<div class="text pl-3">
				    		<h4>Trà sữa</h4>
				    		<p class="mb-0"><a href="#" class="price">$25.99</a><span class="quantity ml-3">Số lượng: 01</span></p>
				    	</div>
				    </div>
				    <div class="dropdown-item d-flex align-items-start" href="#">
				    	...
				    	<div class="text pl-3">
				    		<h4>Trà trái cây </h4>
				    		<p class="mb-0"><a href="#" class="price">$30.89</a><span class="quantity ml-3">Số lượng: 02</span></p>
				    	</div>
				    </div>
				    <div class="dropdown-item d-flex align-items-start" href="#">
				    	<div class="img" style="background-image: url(images/img-03.jpg);"></div>
				    	<div class="text pl-3">
				    		<h4>Coffee</h4>
				    		<p class="mb-0"><a href="#" class="price">$22.50</a><span class="quantity ml-3">Số lượng: 03</span></p>
				    	</div>
				    </div>
				    ...
				    <a class="dropdown-item text-center btn-link d-block w-100" href="checkout.php">
				    	Thanh toán
				    	<span class="ion-ios-arrow-round-forward"></span>
				    </a>
			</div>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="about.php" class="nav-link">Chi Tiết</a></li>
