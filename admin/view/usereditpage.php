                    ...
                    <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Cập nhập thông tin người dùng</h4>
                                </div>
                                <div class="card-content">
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST["id_ngd"]) && isset($_POST["tennguoidung"])&& isset($_POST["gt"])&& isset($_POST["email"])&& isset($_POST["password"])&& isset($_POST["sdt"])&& isset($_POST["diachi"])&& isset($_POST["hd"])&& isset($_POST["ad"]))
                                        {
                                            ...
                                            $sql = "UPDATE nguoidung SET id_ngd='$id', tennguoidung ='$tennguoidung', gioitinh = '$gt',email= '$email', password ='$password', sdt = '$sdt',diachi= '$diachi',hoatdong = '$hd',admin = '$ad' WHERE id_ngd='$id_ngd'";
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Tên người dùng" name="tennguoidung" value = "<?php echo $result[0]['tennguoidung'] ?>">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="email" class="form-control"
                                                                    placeholder="Email" name="email" value = "<?php echo $result[0]['email'] ?>">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="password" class="form-control"
                                                                    placeholder="Mật khẩu" name="password" value = "<?php echo $result[0]['password'] ?>">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Địa chỉ" name="diachi" value = "<?php echo $result[0]['diachi'] ?>">
